...
class Image_Variable extends Starter_Variable {
	...
	function render()
	{
		...
		$html = '<div class="field"><label for="'.$id.'">'.$this->variable->label.':</label><input type="file" name="'.$this->fieldname.'" id="'.$id.'" class="image-manager" data-width="'.$this->variable->options['width'].'" data-height="'.$this->variable->options['height'].'" /><progress></progress></div>';
