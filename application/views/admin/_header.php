...
<html>
	<head>
		<meta charset="utf-8"/>
		<title><?=(isset($title) ? $title.' | ' : '')?><?=(setting('site_name') ? setting('site_name').' | ' : '').($this->config->item('starter_product_name'))?></title>
		<!--[if lt IE 9]>
		...
		<script type="text/javascript" src="<?=base_url()?>assets/shared/js/jquery-1.6.1.min.js"></script>
