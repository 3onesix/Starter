...
<form method="post" action="<?=site_url('admin/settings')?>">
	<h2 id="title" style="position: relative;"><span class="section">Settings &raquo;</span> <span class="page">Manage Users</span> <a href="<?php echo site_url('admin/users/new'); ?>" class="button new user" style="position: absolute; bottom: 5px; right: 0; font-size: 14px;">Add User</a></h2>
		...
		<ul>
			...
			<?php foreach ($users as $user): ?>
				<li<?=($is_odd ? ' class="odd"' : '')?>>
					...
					<div class="actions">
						<a href="<?=site_url('admin/users/edit/'.$user->id)?>" class="edit">edit</a> 
