...
<form method="post" action="<?=site_url('admin/settings/modules')?>">
	...
	<h2 id="title"><span class="section">Settings &raquo;</span> <span class="page">Install Module</span></h2>
	...
	<div id="page_variables">
		...
		<ul class="installables">
			<li>1 screens <span class="note">(Screens are added to the navigation of <?=$this->config->item('starter_product_name')?>)</span></li>
